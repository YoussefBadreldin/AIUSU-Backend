...
const sportsCandidateSchema = new mongoose.Schema({
...
const SportsCandidate = mongoose.model('SportsCandidate', sportsCandidateSchema);

module.exports = { SportsCandidate };
