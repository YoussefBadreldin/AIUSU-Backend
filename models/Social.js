...
const socialCandidateSchema = new mongoose.Schema({
...
const SocialCandidate = mongoose.model('SocialCandidate', socialCandidateSchema);

module.exports = { SocialCandidate };
