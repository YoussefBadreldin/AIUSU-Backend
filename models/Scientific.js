...
const scientificCandidateSchema = new mongoose.Schema({
...
const ScientificCandidate = mongoose.model('ScientificCandidate', scientificCandidateSchema);

module.exports = { ScientificCandidate };
