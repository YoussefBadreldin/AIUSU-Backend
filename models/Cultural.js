...
const culturalCandidateSchema = new mongoose.Schema({
...
const CulturalCandidate = mongoose.model('CulturalCandidate', culturalCandidateSchema);

module.exports = { CulturalCandidate };
